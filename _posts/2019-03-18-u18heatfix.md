...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ sudo cpupower frequency-set --governor powersavecomments with disquscomments with disquscomments with disqus
</code></pre></div></div>
